    ...
    <>
      ...
      <div className="flex justify-center gap-3 mt-32 ">
        <Link
          ...
          to="/gallery/page-1"
          className="text-black inline-flex items-center justify-center text-center text-[18px] border border-solid border-[#dee2e6] w-[48px] h-[45px] font-medium rounded-md bg-[#fffbfb]"
        >
        ...
        <Link
          onClick={() => window.top(0, 0)}
          to="/gallery/page-2"
          className="text-black inline-flex items-center justify-center text-center text-[18px] border border-solid border-[#dee2e6] w-[48px] h-[45px] font-medium rounded-md bg-[#dd6262] "
        >
          2
        </Link>
      </div>
